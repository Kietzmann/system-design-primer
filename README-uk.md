...
>
> Кожна секція містить посилання на ресурси з поглибленого вивчення.
...
**Питання: Чи повинен я знати всю описане тут для інтерв'ю?**

**Відповідь: Ні, не повинен**.

Питання на вашому інтерв'ю будуть залежати від:
...
Зазвичай очікується, що кандидати з більшим досвідом знають більше про системний дизайн.  Архітектори або лідери команд мали б знати більше ніж окремі виконавці.  Ймовірно саме тому найкращі технологічні компанії мають один або кілька раундів інтерв'ю по проектуванню систем.

Одразу розпочинайте з кількох тем.  Це допоможе вам дізнатись трішки про різноманітні ключові теми системного проектування.  Коректуйте цей посібник залежно від вашого часу, досвіду, позиції, на яку ви співбесідуєтесь, і компанії, в яку ви спвібесідуєтесь.
...
Інтерв'ю з системного проектування є **відкритою бесідою**.  Очікується, що ви будете її вести.
...
Згуртуйте вимоги і розмах задачі.  Задавайте питання для вияснення випадків використання та обмежень.  Обговорюйте припущення.
...
* Скільки даних очікуєтся обробляти?
* Скільки запитів в секунду очікується?
* Яким є очікуване співвідношення зчитування до записів?
